...
func newHrabanEncoderDecoder(
	sampleRate int,
	numChannels int,
	frameDuration OPUSFrameDuration,
	bufferSafetyFactor int,
) (*HrabanOpusEncoderDecoder, error) {
...
func (encdec HrabanOpusEncoderDecoder) String() string {
	return fmt.Sprintf("Type: Hraban, Sample Rate: %d, Num Channels: %d, Frame Duration %d", encdec.sampleRate, encdec.numChannels, encdec.frameDuration)
}

func (encdec HrabanOpusEncoderDecoder) GetFrameDuration() time.Duration {
